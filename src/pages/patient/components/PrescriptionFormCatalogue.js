...
const PrescriptionFormCatalogue = ({
  title = "",
  type = "",
  group = "",
  url = { get: "", post: "" },
        ...
        <form className={""} onSubmit={formik.handleSubmit} noValidate>
          ...
          <>
            ...
            <div className="form-label mt-3">
              {"Sélectionnez un catalogue de biologie"}
            </div>
            <Typeahead
              id="basic-typeahead-family"
              labelKey="label"
              options={data}
              placeholder="Veuillez choisir un catalogue de biologique"
...
export default PrescriptionFormCatalogue;
