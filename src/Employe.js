        ...
        <div className="row">
          ...
          >
            <div className="position-sticky h-100 text-small">
              <div className="col-12 text-center py-5 m-0">
                <img src={mc} alt="" />
              </div>
              <ul className="nav flex-column">
                <li className="nav-item">
                  <Link to="#" className="nav-link active">
                    <span className="d-lg-none wd-0">
                      <img src={home} alt="" />
                    </span>
                    <span className="d-none d-lg-block wd-80 align-middle">
                      Accueil
                    </span>
                  </Link>
                </li>
                <li className="nav-item">
                  <Link to="#" className="nav-link">
                    ...
                    <span className="d-none d-lg-block wd-80">
                      Mon agenda
                    </span>
                  </Link>
                </li>
              ...
              <ul className="nav flex-column w-100 position-absolute bottom-0">
                <li className="nav-item link-border mb-2">
                  <Link to="#" className="nav-link">
                    <img src={msg} alt="" />
                ...
                <li className="nav-item link-border link-border-primary mb-2">
                  <Link to="#" className="nav-link">
                    <img
          ...
          <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 pt-5 h-90 text-small">
